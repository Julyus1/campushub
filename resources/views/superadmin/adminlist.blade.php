...
<body id="page-top">
    ...
    <form method="POST" action='{{ url('superadmin/admin/register') }}'>
        @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="last_name" id="last_name" class="form-control form-control-border" placeholder="Enter Admin Last Name" required>
                    </div>
                    <div class="modal-body">
                        <label for="first_name" class="control-label">First Name</label>
                        <input type="text" name="first_name" id="first_name" class="form-control form-control-border" placeholder="Enter Admin First Name" required>
                    </div>
                    <div class="modal-body">
                        <label for="edit_middleinitial" class="control-label">Middle Name</label>
                        <input type="text" name="middle_name" id="middle_name" class="form-control form-control-border" placeholder="Enter Admin Middle Initial" required>
                    </div>
                    <div class="modal-body">
                        <label for="dept_name" class="control-label">Department</label>
                        <select name="dept_id" id="deptname" class="form-control form-control-sm form-control-border" required>
            ...
            <div class="modal-content">
                <form id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="last_name" id="edit_last_name" class="form-control form-control-border" placeholder="Enter Admin Last Name" required>
                    </div>
                    <div class="modal-body">
                        <label for="edit_first_name" class="control-label">First Name</label>
                        <input type="text" name="first_name" id="edit_first_name" class="form-control form-control-border" placeholder="Enter Admin First Name" required>
                    </div>
                    <div class="modal-body">
                        <label for="edit_middle_name" class="control-label">Middle Initial</label>
                        <input type="text" name="middle_name" id="edit_middle_name" class="form-control form-control-border" placeholder="Enter Admin Middle Initial" required>
                    </div>
                    <div class="modal-body">
                        <label for="edit_dept" class="control-label">Department</label>
                        <select name="dept_id" id="edit_dept" class="form-control form-control-sm form-control-border" required>
                            @foreach ($departments as $department )
                            <option value="{{ $department->id }}">{{ $department->title }}</option>
                            @endforeach
                        </select>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            $(document).ready(function() {
                $('.edit_data').on('click', function() {
                    ...
                    $('#edit_middle_name').val(middleinitial);
                    $('#edit_dept').val(dept_id);

                    // Dynamically set the form action URL
                    $('#editForm').attr('action', "{{ url('superadmin/admin/update') }}/" + id);
                });
            });
