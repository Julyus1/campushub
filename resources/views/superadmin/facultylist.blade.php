            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">List of Faculties</h1>
                        <div class="d-inline-block btn btn-sm btn-primary shadow-sm add-btn" id="editBtn">
                            <i class="fas fa-plus fa-sm text-white-50"></i><a href="{{ url('faculty/register') }}" style="text-decoration: none; color:  white;"> Add New Faculty</a>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td items-align="center">
                                                <a href="{{url('faculty/profile/' . $faculty->id) }}" class="btn btn-flat btn-default btn-sm border">
