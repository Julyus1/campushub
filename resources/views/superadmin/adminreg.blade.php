...
<head>
    ...
    <title>CampusHub - Admin Registration</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Admin Information Management</h1>
                    </div>

                    <!-- admin Information Form -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Admin Registration</h6>
                        </div>
                        <form method="POST" action="{{ url('admin/register') }}">
                            ...
                            <div class="card-footer text-right">
                                <button class="btn btn-flat btn-primary btn-sm" type="submit">Save Admin Details</button>
                                <a href="./?page=admin" class="btn btn-flat btn-default border btn-sm">Cancel</a>
                            </div>
                        </form>
                    </div>
